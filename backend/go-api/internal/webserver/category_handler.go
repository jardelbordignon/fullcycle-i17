...
func (wch *WebCategoryHandler) UpdateCategory(w http.ResponseWriter, r *http.Request) {
	var category entity.Category
	...
	result, err := wch.CategoryService.UpdateCategory(id, category.Name)
...
func (wch *WebCategoryHandler) DeleteCategory(w http.ResponseWriter, r *http.Request) {
	id := chi.URLParam(r, "id")
	...
	err := wch.CategoryService.DeleteCategory(id)
